...
class Donation(models.Model):
    ...
    transaction_state = models.CharField(max_length=50, choices=TRANSACTION_STATE_CHOICES, default=PENDING)

    amount = models.DecimalField(decimal_places=2, max_digits=20, validators=[validate_positive])
